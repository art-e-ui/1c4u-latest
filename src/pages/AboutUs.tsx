  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4 text-foreground">About 1-CartForU</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            At 1-CartForU, our mission is to provide customers worldwide with access to high-quality products from trusted global brands. We believe that shopping should be easy, secure, and accessible to everyone, regardless of where they are located.
          </p>
      ...
      <div className="bg-primary text-primary-foreground rounded-3xl p-10 text-center">
        ...
        <p className="mb-8 opacity-90 max-w-xl mx-auto">
          Experience the future of global e-commerce with 1-CartForU. Start shopping today and discover a world of possibilities.
        </p>

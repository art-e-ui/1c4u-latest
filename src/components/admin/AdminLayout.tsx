...
import { useAdminGlobalNotifications } from "@/hooks/use-admin-notifications";
...
const canonicalPageTitles: Record<string, { title: string; breadcrumb: React.ReactNode }> = {
  "/admin": { title: "Dashboard", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
  "/admin/inventory": { title: "Inventory", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
  "/admin/orders": { title: "Orders", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
  "/admin/customers": { title: "Customers", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
  "/admin/resellers": { title: "Retail-shops", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
  "/admin/customer-service": { title: "Customer Service", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
  "/admin/content": { title: "Content", breadcrumb: <><span className="text-brand-green">1-Cart</span><span className="text-brand-gold">ForU</span></> },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Call global notifications hook (it mounts listeners if user has permissions)

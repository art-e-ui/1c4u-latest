      ...
      try {
        ...
        const resellers: Reseller[] = profilesSnapshot.docs.map(profileDoc => {
          ...
          return {
            ...
            referralId,
            level: (retailShopData.vipLevel || retailShopData.level as string) || 'VIP-0',
            productLimit: (retailShopData.productsLimit || retailShopData.product_limit as number) || 20,
            starRating: (retailShopData.starRating || retailShopData.star_rating as number) || 2.0,
            creditScore: (retailShopData.creditScore || retailShopData.credit_score as number) || 100,
            selectedProductIds: [],

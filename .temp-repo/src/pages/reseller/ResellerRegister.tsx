    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm space-y-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-[2px] p-6 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {showVerification && (
            <div>
              <label className="text-sm font-medium text-white/80 mb-1.5 block">{t("reseller.verificationCode")}</label>
              <div className={inputBoxClass}>
              ...
              <button type="button" onClick={handleVerify} className="w-full mt-2 rounded-lg bg-white/20 py-2 text-sm font-medium text-white hover:bg-white/30 transition-colors">
